...
import { openBlock, createBlock, resolveDynamicComponent, withCtx, renderSlot, markRaw, shallowReactive, resolveComponent, resolveDirective, withDirectives, createElementBlock, normalizeClass, createCommentVNode, normalizeStyle, Fragment, renderList, mergeProps, toHandlers, createVNode, createSlots, normalizeProps, guardReactiveProps, h, reactive } from 'vue';
...
function parents(_x, _x2) {
  return _parents.apply(this, arguments);
}
function _parents() {
  _parents = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(node, ps) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          ps = _context.t0.concat.call(_context.t0, _context.t2);
        case 7:
        ...
        case 9:
          return _context.abrupt("return", parents(node.parentNode, ps.concat([node])));
        case 10:
        case "end":
...
function getScrollParent(_x3) {
  return _getScrollParent.apply(this, arguments);
}
function _getScrollParent() {
  _getScrollParent = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(node) {
    var ps, i;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          _context2.next = 4;
          return parents(node.parentNode, []);
        case 4:
          ps = _context2.sent;
          i = 0;
        case 6:
          ...
          return _context2.abrupt("return", ps[i]);
        case 9:
          i += 1;
          _context2.next = 6;
          break;
        case 12:
          return _context2.abrupt("return", document.scrollingElement || document.documentElement);
        case 13:
        case "end":
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock(resolveDynamicComponent($props.itemTag), { class: "vue-recycle-scroller__item-view" }, {
    default: withCtx(() => [
...
script$3.__file = "src/components/ItemView.vue";
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_ItemView = resolveComponent("ItemView");
    ...
    (openBlock(), createBlock(resolveDynamicComponent($props.listTag), {
      ...
      default: withCtx(() => [
        (openBlock(true), createElementBlock(Fragment, null, renderList($data.pool, (view) => {
          return (openBlock(), createBlock(_component_ItemView, mergeProps({
            ref_for: true,
            ref: "items",
            key: view.nr.id,
            view: view,
          ...
          ? [
            ($props.disableTransform
              ? { [_ctx.direction === 'vertical' ? 'top' : 'left'] : `${view.position}px`, willChange: 'unset' }
          ...
          mouseleave: () => { $data.hoverKey = null; },
            ...
            default: withCtx((props) => [
              renderSlot(_ctx.$slots, "default", mergeProps({ ref_for: true }, props))
            ]),
            _: 2 /* DYNAMIC */
          }, 1040 /* FULL_PROPS, DYNAMIC_SLOTS */, ["view", "item-tag", "style", "class"]))
        }), 128 /* KEYED_FRAGMENT */)),
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock(_component_RecycleScroller, mergeProps({
    ...
    (_ctx.$slots.after)
      ...
      : undefined
  ]), 1040 /* FULL_PROPS, DYNAMIC_SLOTS */, ["items", "min-item-size", "direction", "list-tag", "item-tag", "onResize", "onVisible"]))
}
