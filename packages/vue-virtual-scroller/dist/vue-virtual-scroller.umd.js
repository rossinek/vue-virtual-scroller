(function (global, factory) {
  ...
  script$4.__scopeId = "data-v-b329ee4c";
  script$4.__file = "src/components/ResizeObserver.vue";
  ...
  function render$2(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.itemTag), { class: "vue-recycle-scroller__item-view" }, {
      default: vue.withCtx(() => [
  ...
  function render$1(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_ItemView = vue.resolveComponent("ItemView");
      ...
      (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.listTag), {
        ...
        default: vue.withCtx(() => [
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($data.pool, (view) => {
            return (vue.openBlock(), vue.createBlock(_component_ItemView, vue.mergeProps({
              ref_for: true,
              ref: "items",
              key: view.nr.id,
              view: view,
            ...
            mouseleave: () => { $data.hoverKey = null; },
              ...
              default: vue.withCtx((props) => [
                vue.renderSlot(_ctx.$slots, "default", vue.mergeProps({ ref_for: true }, props))
              ]),
              _: 2 /* DYNAMIC */
